...
$mysql_latest = [Version]'9.4.0'
$mysql_ver = [Version]'9.4.0'

# status: long-term developemnt releases
$mariadb_ver = [Version]'11.8.3'
...
$php_latset = [Version]'8.4.11'
$php_ver = [Version]'8.4.11'
...
$xdebug_ver_map = @{'7.4' = '3.1.6' ; '8.4' = '3.4.5'}
